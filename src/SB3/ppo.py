...
from src.SB3.buffer import DictRolloutBuffer
from src.SB3.policy import ActorCriticPolicy_Aux
...
class PPO_AUX(PPO):
    ...
    def train(self) -> None:
        ...
        for epoch in range(self.n_epochs):
            ...
            for rollout_data in self.rollout_buffer.get(self.batch_size):
                ...
                loss = policy_loss + self.ent_coef * entropy_loss + self.vf_coef * value_loss + 0.1 * aux_loss
    ...
    def collect_rollouts(
        ...
        while n_steps < n_rollout_steps:
            ...
            aux_angle_gt = np.array([[infos[i]['true_aux']] for i in range(self.env.numb_envs)])
